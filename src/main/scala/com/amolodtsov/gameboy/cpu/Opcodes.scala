...
object Opcodes {
  ...
  var COMMANDS: Array[Command] = new Array[Command](0xff+1)
  var EXT_COMMANDS: Array[Command] = new Array[Command](0xff+1)
  ...
  private def regCmd(command: Array[Command], opcode: Int, cycles: Int, argsLength: Int, label: String, operation: Command.Operation): Unit = {
    command(opcode) = new Command(opcode, cycles, argsLength, label, operation)
  }
